    ...
    <div className="wrap flex flex-row flex-nowrap">
      ...
      <div className="p-5">
        <h3 className="text-4xl font-bold">
          The health and wellness newsletter you’ve been looking for
        </h3>
        <p className="text-2xl  font-normal my-5">
          Interested in exclusive interviews, must-have products, and staying
          updated with trending news? Wellness Wire has it all, and you don’t
          want to miss out.
        </p>
