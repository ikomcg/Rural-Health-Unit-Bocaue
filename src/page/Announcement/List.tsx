      ...
      <>
         {news === undefined ? (
            ...
            news.map((item) => {
               return (
                  <div
                     className={`flex flex-col w-[60%] border border-1 border-gray-400 rounded-lg pt-5 overflow-hidden mb-10 py-10`}
                  >
                     ...
                     <div className="flex flex-col h-[90%]">
                        ...
                        <div
                           className={`${style.news_image} relative w-[100%] mx-auto grid_container_${item.images.length} `}
                        >
