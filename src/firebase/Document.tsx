...
export const GetDocFireBase = async(documentRef : DocumentReference<DocumentData, DocumentData>) => {
...
export const GetDocsFireBase = async(documentRef : Query<DocumentData, DocumentData>) => {
